...
Phantom either facilitates the combination of four separate transformations: Unhooking, Evasion, Obfuscation, and Masquerading.
...
**Mitigates: \[** [_Dynamic Analysis_](https://github.com/jt0dd/phantom/blob/main/README.md#defense-dynamic-analysis) **\]**
...
**Mitigates: \[** [_Static Analysis_](https://github.com/jt0dd/phantom/blob/main/README.md#defense-static-analysis), [_Dynamic Analysis_](https://github.com/jt0dd/phantom/blob/main/README.md#defense-dynamic-analysis), [_Baselining_](https://github.com/jt0dd/phantom/blob/main/README.md#defense-baselining) **\]**
...
The transforms exposed in phantom are all simply abstractions of those functionalities imported from projects I've published separately, since they're all useful as standalone libraries:
